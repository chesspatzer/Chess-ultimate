...
/**
 * Queen class that extends PieceImpl abstract class
 */
public class Queen extends PieceImpl {

    //initial positions of the queen
    ...
    /**
     * Queen constructor that constructs the rook piece
     ...
     */
    public Queen(int row, int col, Color color, Square[][] squares) {
     ...
     * @param squares squares of the board
     */
    public Queen(int row, int col, Color color, int boardSize, Square[][] squares) {
        super(color, row, col, Notation.Q, boardSize, squares);
    }
    ...
    public boolean checkLegality(char file, int rank) {
        ...
        boolean pathValid = Math.abs(getRowPos() - row) == Math.abs(getColPos() - col) || (getRowPos() == row || getColPos() == col);
